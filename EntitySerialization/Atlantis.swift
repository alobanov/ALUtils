...
public class Atlantis: NSObject {
  @objc
  public static var logger: Atlantis.Logger { return log }
  ...
  public struct XCodeColor {
    ...
    fileprivate var fg: (Int, Int, Int)?
    fileprivate var bg: (Int, Int, Int)?
  ...
  public class Logger: NSObject {
    ...
    fileprivate static func calculateLegibleWhitespace(_ log: String, startString: String, endString: String, logLevel _: LogLevel) -> String {
